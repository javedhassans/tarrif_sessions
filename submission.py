...
# finally manipulate data to get the desired output
df['minutes'] = (df['dt_end'] - df['dt_start']).dt.components.minutes
...
print('time taken for overall operations is {} mins'.format(round(time.time()-start_time),2)/60))
